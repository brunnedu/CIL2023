...
UNET_MODEL_CONFIG = {
    'model_cls': UNetPP,
    'backbone_cls': Resnet152Backbone,
    'model_kwargs': {
        'up_block_ctor': lambda ci: UpBlock(ci, up_mode='upconv', activation=nn.LeakyReLU(inplace=True)),
    },
    'backbone_kwargs': {
