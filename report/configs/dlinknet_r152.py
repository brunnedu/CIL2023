...
TRAIN_CONFIG = {
    'experiment_id': 'dlinknet_r152_30k',  # should be changed for every run
    'resume_from_checkpoint': False,  # set full experiment id (including timestamp) to resume from checkpoint
    'train_dataset_kwargs': {
        'data_dir': '/cluster/scratch/{ETHZ_NAME}/data30k',  # use our data for training
...
RUN_CONFIG = {
    'experiment_id': 'dlinknet_r152_30k_2023-07-19_17-58-28',
    'dataset_kwargs': {
        'data_dir': 'data/test',
