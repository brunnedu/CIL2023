...
TRAIN_CONFIG = {
    'experiment_id': 'votenet-distance',  # should be changed for every run
    ...
    'train_dataset_kwargs': {
        ...
        'groundtruth_subfolder': 'transformed/distance',
    },
    'val_dataset_kwargs': {
...
# used the last checkpoint when running instead of the best one!
RUN_CONFIG = {
    'experiment_id': 'votenet-distance',
    'dataset_kwargs': {
